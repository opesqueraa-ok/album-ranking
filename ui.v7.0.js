// UI v7.0 wiring (lang/export/import/clear + notes + better export name)
(function () {
  ...
  const NOTES_KEY = "albumrater_v7_notes";
  ...
  function currentLang() {
    const fromStorage = localStorage.getItem(KEY_LANG);
  ...
  function clearAll() {
    ...
    // Mantener las notas en storage; solo vaciamos la pantalla
