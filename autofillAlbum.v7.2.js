...
(() => {
  ...
  function render() {
    ...
    thead.innerHTML = `
      <tr>
        <th style="width:80px">${LANG === "es" ? "Duración" : "Duration"}</th>
    ...
    $("#finalScore").textContent = Number.isFinite(avg) ? avg.toFixed(1) : "—";
  ...
  function bind() {
    ...
    $("#delRow").addEventListener("click", () => {
      ensureRows(Math.max(1, tracksEls().children.length - 1));
    });
